...
rerun_analyseLFP = false; 
rerun_AddPop = true; 
load('experiments_lfp_Quigley_207_spectro_trial_stop')
...
rerun_analyseLFP = false; 
rerun_AddPop = true; 
load('experiments_lfp_Quigley_188_spectro_trial_stop')
...
rerun_analyseLFP = false; 
rerun_AddPop = true; 
load('experiments_lfp_Quigley_185_spectro_trial_stop')
...
rerun_analyseLFP = false; 
rerun_AddPop = true; 
load('experiments_lfp_Bruno_43_spectro_trial_stop')
...
rerun_analyseLFP = false; 
rerun_AddPop = true; 
load('experiments_lfp_Bruno_42_spectro_trial_stop')
...
rerun_analyseLFP = false; 
rerun_AddPop = true; 
load('experiments_lfp_Bruno_41_spectro_trial_stop')
...
rerun_analyseLFP = false; 
rerun_AddPop = true; 
load('experiments_lfp_Bruno_38_spectro_trial_stop')

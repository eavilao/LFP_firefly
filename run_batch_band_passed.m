name_load_exp = 'band_passed';
name_save_exp = 'band_passed';
%%
...
disp('Saving... . .' )
save(['experiments_lfp_Viktor_1_' name_exp], 'experiments', '-v7.3')
clear experiments
%%
rerun_analyseLFP = true; 
rerun_AddPop = true;  
...
disp('Saving... . .' )
save(['experiments_lfp_Viktor_2_' name_exp], 'experiments', '-v7.3')
clear experiments
%%
% rerun_analyseLFP = true; 
% rerun_AddPop = true;  
...
% end
% disp('Saving... . .' )
% save(['experiments_lfp_Viktor_3_' name_exp], 'experiments', '-v7.3')
% clear experiments
%%
rerun_analyseLFP = true; 
rerun_AddPop = true;  
...
disp('Saving... . .' )
save(['experiments_lfp_Viktor_4_' name_exp], 'experiments', '-v7.3')
clear experiments

...
if extract_behv_only
    ...
    cd('E:\Output\behavior')
    disp('   Saving ....')
    save('experiments_lfp_Bruno_38_41_42_43_only_behv', 'experiments', '-v7.3')
    clear experiments
    ...
    cd('E:\Output\behavior')
    disp('   Saving ....')
    save('experiments_lfp_Schro_86_107_113_only_behv', 'experiments', '-v7.3')
    clear experiments

...
monkeyInfo (end).electrode_type = {'linearprobe24', 'utah96',};
...
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, Cannot segment LFP: Trial counts in smr and plx files do not match '};
monkeyInfo (end).electrode_type = {'utah96', 'linearprobe24'};
monkeyInfo (end).area = {'PPC', 'MST'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, 1D Azimuth, MSTd, PLX files trial missmatch'};
monkeyInfo (end).electrode_type = {'linearprobe24', 'utah96',};
monkeyInfo (end).area = {'MST', 'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).comments = {'four densities, no ptb, rno landmarks, andom DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah96'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, fixed ITI, multifirefly, 1D Azimuth, MSTd, PPC, PFC, MST'};
...
%% session 91 % Two repeated sessions
monkeyInfo (end+1).monk_id = 53;
monkeyInfo (end).session_id = 91;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
...
%% session 102  This session is not in the excel sheet
monkeyInfo (end+1).monk_id = 53;
monkeyInfo (end).session_id = 102;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
...
%% session 102 This session does not exist in the excel sheet or the server
% monkeyInfo (end+1).monk_id = 53;
% monkeyInfo (end).session_id = 102;
% monkeyInfo (end).coord.row = nan;
% monkeyInfo (end).coord.column = nan;
...
%% session 103  This session does not exist in the excel sheet or the server
% monkeyInfo (end+1).monk_id = 53;
% monkeyInfo (end).session_id = 103;
% monkeyInfo (end).coord.row = nan;
% monkeyInfo (end).coord.column = nan;
...
% monkeyInfo (end).coord.depth = nan;  
% monkeyInfo (end).units = 0;
% monkeyInfo (end).folder = 'Ody\Utah array\Aug 15 2019';
% monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
% monkeyInfo (end).electrode_type = {'utah2x48'};
% monkeyInfo (end).area = {{'PPC', 'PFC'}};
% monkeyInfo (end).eyechannels = [2 2];
...
% monkeyInfo (end).coord.depth = nan;  
% monkeyInfo (end).units = 0;
% monkeyInfo (end).folder = 'Ody\Utah array\Oct 18 2019'; % 'Ody\Sim_recordings\Oct 18 2019';
% monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
% monkeyInfo (end).electrode_type = {'utah2x48'};
% monkeyInfo (end).area = {{'PPC', 'PFC'}};
% monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 16 2019';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 17 2019';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Oct 18 2019';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];

...
=======
save('exp_out_lfp_stats_pop_2020_08_26_coherence_align_target_stop','exp', '-v7.3');
>>>>>>> 4fed999e18b446229cc8547c8e50d7e79a5d55ad
% load train
% sound(y,Fs)
disp('           Saved! ')
fprintf(['Time:  ' num2str(clock) '\n']);
...
%% Save
    ...
    save('lfp_pop_sim_2020_08_20_coherence_align_target_stop', 'monk', 'all_monks', '-v7.3');
    load train
    sound(y,Fs)
    disp('                     Saved!')
    fprintf(['Time:  ' num2str(clock) '\n']);
